...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    fdigit, sdigit = score // 10, score % 10
    return 2 + abs(fdigit - sdigit)
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if score0 != 1 and score0 != 0 and score1 != 1 and score1 != 0:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            play = strategy0(score0, score1)
            score0 = score0 + take_turn(play, score1, dice)
            player = other(player)
        else:
            play = strategy1(score1, score0)
            score1 = score1 + take_turn(play, score0, dice)
            player = other(player)
    ...
    def comp(score_0, score_1):
        ...
        if diff > previous_high:
            if diff == 1:
                ...
                return announce_highest(who, 1, score)
            else:
                print(diff, "points! That's the biggest gain yet for Player", who)
                return announce_highest(who, diff, score)
            #f diff < previous_high:
                #print("Player", who, "gets", diff, "points; not enough for a new high")
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    temp, count, temp1, result = 0, 1, 0, 0
    while count <= 10:
        temp = make_averaged(roll_dice, num_samples)(count, dice)
        if temp > temp1:
            temp1 = temp
            result = count
        count += 1
